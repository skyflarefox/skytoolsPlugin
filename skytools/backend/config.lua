local config = {
    ...
    API_MANIFEST_URL = "https://github.com/skyflarefox/plugin/raw/refs/heads/main/plugin/load_free_manifest_apis",
    API_MANIFEST_PROXY_URL = "https://github.com/skyflarefox/plugin/raw/refs/heads/main/plugin/load_free_manifest_apis",
